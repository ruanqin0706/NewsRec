...
model.model.load_weights("/root/models/npa/ckpt_1_0.6705")

model.fit(train_news_file, train_behaviors_file, valid_news_file, valid_behaviors_file, model_dir=args.model_dir)
